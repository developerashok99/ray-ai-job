...
EXP_MIN_RE = re.compile(
    ...
    # "N-M years experience", "N to M yrs of experience", "N\-M yrs" (LinkedIn markdown)
    rf"|\b({_YRS})\s*\\?(?:[-–]|to)\s*\d+\s*(?:years?|yrs?)\s+(?:of\s+)?(?:\w+\s+){{0,3}}experience"
    ...
    # "N years of relevant/professional/work/hands-on experience"
